    ...
    <div className="container mx-auto px-4 py-24 max-w-4xl text-center">
      ...
      <div className="space-y-12 text-white/60 font-medium leading-relaxed">
        <section className="space-y-6">
          ...
          <p>
            L&apos;expertise de Platform Navigator repose sur une analyse rigoureuse des platforms de reviews en ligne agréées par l&apos;ANJ. Chaque site est évalué selon des critères stricts de sécurité, de fluidité et de transparence.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-6">
            <div className="bg-white/5 p-6 rounded-xl border border-white/5">
              ...
              <p className="text-[10px]">Vérification systématique des licences de l&apos;Autorité Nationale.</p>
            </div>
            <div className="bg-white/5 p-6 rounded-xl border border-white/5">
              <div className="text-accent text-2xl mb-2">⚡</div>
              <h3 className="text-white font-black text-xs uppercase mb-2">Rapidité</h3>
              <p className="text-[10px]">Test réel des délais d&apos;accès et de validation des documents.</p>
            </div>
            <div className="bg-white/5 p-6 rounded-xl border border-white/5">
              <div className="text-accent text-2xl mb-2">🛡️</div>
        ...
        <section className="space-y-6">
          ...
          <p>
            Notre rôle est d&apos;orienter les utilisateurs vers les meilleures offers tout en garantissant un environnement de platforms sain. Nous mettons à jour quotidiennement nos données pour refléter les évolutions du marché français.
          </p>
        </section>
      </div>
    </div>
