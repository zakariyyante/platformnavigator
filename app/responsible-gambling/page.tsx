  ...
  return (
    <div className="container mx-auto px-4 py-24 max-w-4xl text-center">
      <h1 className="text-4xl md:text-5xl font-black text-white mb-12 tracking-tight">
        Service Et Assistance : Platforms Responsable
      </h1>
      
      <div className="space-y-16 text-white/60 font-medium leading-relaxed">
        <section className="space-y-6">
          <p className="text-lg">
            L&apos;utilisation des platforms doit rester un plaisir et un divertissement. Chez Platform Navigator, la protection des utilisateurs est au cœur de notre mission.
          </p>
          <div className="bg-red-600/10 border border-red-600/20 p-8 rounded-2xl max-w-2xl mx-auto">
            ...
            <p className="text-sm mb-6">
              Si vous sentez que l&apos;utilisation des platforms devient un problème, des professionnels sont à votre écoute 24h/24 et 7j/7.
            </p>
        ...
        <section className="space-y-8 max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-left">
            <div className="space-y-2">
              ...
              <p className="text-xs">Déterminez un budget et un temps d&apos;utilisation avant de commencer, et respectez-les scrupuleusement.</p>
            </div>
            <div className="space-y-2">
              <h3 className="text-white font-bold text-sm uppercase">Ne vous endettez pas</h3>
              <p className="text-xs">N&apos;utilisez jamais d&apos;argent que vous ne pouvez pas vous permettre de perdre.</p>
            </div>
            <div className="space-y-2">
              <h3 className="text-white font-bold text-sm uppercase">Ceci n&apos;est pas un travail</h3>
              <p className="text-xs">Ne considérez jamais les platforms comme une source de revenus ou un moyen de rembourser des dettes.</p>
            </div>
            <div className="space-y-2">
              <h3 className="text-white font-bold text-sm uppercase">Gardez le contrôle</h3>
              <p className="text-xs">Si le plaisir s&apos;arrête, arrêtez. Faites des pauses régulières.</p>
            </div>
          </div>
        </section>
